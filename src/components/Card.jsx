...
import { axiosInstance } from "../service/api"; // Import your axiosInstance

export const Card = ({ character, currentUsername }) => {
...
<div style={{display:"flex", justifyContent:"space-between"}}>
  <p style={{fontSize:"14px"}} ><b>Pet name:</b></p>
  <input
    value={editData.ad_title}
    onChange={(e) => setEditData({ ...editData, ad_title: e.target.value })}
  />
</div>
...
<div style={{display:"flex", justifyContent:"space-between"}}>
  <p style={{fontSize:"14px"}}><b>Date of Birth:</b></p>
  <input
    value={editData.pet_date_of_birth}
    onChange={(e) => setEditData({ ...editData, pet_date_of_birth: e.target.value })}
  />
</div>

<div style={{display:"flex", justifyContent:"space-between"}}>
  <p style={{fontSize:"14px"}}><b>Price:</b></p>
  <input
...
<div style={{display:"flex", justifyContent:"space-between"}}>
  <p style={{fontSize:"14px"}}><b>City:</b></p>
  <input
    value={editData.city}
...
<div style={{display:"flex", justifyContent:"space-between"}}>
  <p style={{fontSize:"14px"}}><b>Address:</b></p>
  <input
...
<div style={{display:"flex", justifyContent:"space-between"}}>
  <p style={{fontSize:"14px"}}><b>Phone Number:</b></p>
  <input
  ...
  />
        ...
        <>
          ...
          {character.user.username === currentUsername && (
            <div className="edit-but">
